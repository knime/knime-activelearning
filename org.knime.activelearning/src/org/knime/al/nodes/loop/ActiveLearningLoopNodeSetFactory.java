...
import org.knime.al.nodes.loop.end.ActiveLearningLoopEndNodeFactory;
import org.knime.al.nodes.loop.start.ActiveLearningLoopStartNodeFactory;
 ...
 */
public class ActiveLearningLoopNodeSetFactory implements NodeSetFactory {
    ...
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(ActiveLearningLoopNodeSetFactory.class);
    ...
    public Collection<String> getNodeFactoryIds() {
        m_nodeFactories.put(
                ActiveLearningLoopStartNodeFactory.class.getCanonicalName(),
                CATEGORY_PREFIX);
        m_nodeFactories.put(
                ActiveLearningLoopEndNodeFactory.class.getCanonicalName(),
                CATEGORY_PREFIX);
