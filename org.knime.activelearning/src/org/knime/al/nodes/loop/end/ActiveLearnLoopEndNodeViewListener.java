...
import org.knime.al.nodes.loop.end.components.ClassCellEditor;
import org.knime.al.nodes.loop.end.components.ClassCellRenderer;
import org.knime.al.nodes.loop.end.components.ClassListModel;
...
public class ActiveLearnLoopEndNodeViewListener implements ActionListener,
    ...
    // FIXME needs to be private again
    ClassCellEditor m_classCellEditor; // cell editor for the class
