 ...
 */
public abstract class AbstractDensityDataPoint <V extends AbstractDensityDataPoint<V>> implements DensityDataPoint<V> {
    ...
    /**
     * @param key the {@link RowKey} of the corresponding row
     * @param vector the feature vector
     */
    public AbstractDensityDataPoint(final RowKey key, final double[] vector) {
        m_vector = vector;
        m_key = key;
    }
    ...
    /**
     * @param amount the density is increased by
     */
    @Override
    ...
    /**
     * @param value the new value for the density
     */
    @Override
