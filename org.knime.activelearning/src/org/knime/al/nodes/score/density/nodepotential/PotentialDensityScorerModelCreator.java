 ...
 */
final class PotentialDensityScorerModelCreator extends AbstractDensityScorerModelCreator<PotentialDataPoint> {
    ...
    PotentialDensityScorerModelCreator(final int numFeatures, final double radiusAlpha) {
        super(numFeatures);
