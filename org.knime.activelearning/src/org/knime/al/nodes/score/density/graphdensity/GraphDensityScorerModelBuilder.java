 ...
 */
final class GraphDensityScorerModelBuilder extends AbstractDensityScorerModelBuilder<GraphDataPoint> {
     ...
     */
    public GraphDensityScorerModelBuilder(final int nrFeatures, final double sigma, final int nrNeighbors) {
        super(nrFeatures);
