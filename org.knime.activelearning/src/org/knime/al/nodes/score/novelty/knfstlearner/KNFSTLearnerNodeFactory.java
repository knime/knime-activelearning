 ...
 *
 */
public class KNFSTLearnerNodeFactory
        extends NodeFactory<KNFSTLearnerNodeModel> {
     ...
     */
    @Override
    public NodeView<KNFSTLearnerNodeModel> createNodeView(final int viewIndex,
            final KNFSTLearnerNodeModel nodeModel) {
        return null;
    }
