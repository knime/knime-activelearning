 ...
 *
 */
public class LocalNoveltyScorerNodeFactory
        extends NodeFactory<LocalNoveltyScorerNodeModel> {
     ...
     */
    @Override
    public NodeView<LocalNoveltyScorerNodeModel> createNodeView(
            final int viewIndex, final LocalNoveltyScorerNodeModel nodeModel) {
        return null;
    }
