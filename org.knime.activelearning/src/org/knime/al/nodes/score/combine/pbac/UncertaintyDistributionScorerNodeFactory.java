...
public class UncertaintyDistributionScorerNodeFactory
     ...
     */
    @Override
    public UncertaintyDistributionScorerNodeModel createNodeModel() {
        return new UncertaintyDistributionScorerNodeModel();
    }
        ...
        return new DefaultNodeSettingsPane() {
            {
                addDialogComponent(new DialogComponentColumnNameSelection(
                        UncertaintyDistributionScorerNodeModel
                                .createExploitationColumnModel(),
                        "Exploitation Score Column", 0, true,
                        DoubleValue.class));

                addDialogComponent(new DialogComponentColumnNameSelection(
                        UncertaintyDistributionScorerNodeModel
                                .createExplorationColumnModel(),
                        "Exploration Score Column", 0, true,
                        DoubleValue.class));
