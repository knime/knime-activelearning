#!groovy
def BN = "todo/DEVOPS-3280-update-the-target-platform"   // (temporarily redirected) def BN = (BRANCH_NAME == 'master' || BRANCH_NAME.startsWith('releases/')) ? BRANCH_NAME : 'releases/2025-12'
